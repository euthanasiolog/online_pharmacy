...
public class SQLScripts {
    final static String DOCTOR_SIGN_IN_SQL = "SELECT u.id, u.nickname, u.email, u.type FROM user u\n" +
            "WHERE u.nickname=? AND u.password = SHA2(?,512);";
    final static String CLIENT_SIGN_IN_SQL = "";
    final static String PHARMACIST_SIGN_IN_SQL = "";
